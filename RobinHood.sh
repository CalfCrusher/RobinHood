...
cat subdomains_$HOST.txt | $HTTPX -mc 200,401,403,404,500 -silent | tee live_subdomains_$HOST.txt
...
python3 $DIRSEARCH -l live_subdomains_$HOST.txt --max-time=86400 -e php,aspx,txt,sql,bak -w $DIRSEARCH_WORDLIST -q -t 10 -i 200,307,301,302 -o dirsearch_results.txt --format=plain
